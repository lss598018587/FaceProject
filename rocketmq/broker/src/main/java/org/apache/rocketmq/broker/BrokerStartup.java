...
public class BrokerStartup {
    ...
    public static BrokerController createBrokerController(String[] args) {
        ...
        try {
            ...
            //初始化配置文件
            final BrokerConfig brokerConfig = new BrokerConfig();//todo 先睡环境需要调整两项配置 autoCreateTopicEnable=false
            ...
            final MessageStoreConfig messageStoreConfig = new MessageStoreConfig();//消息存储store配置
